<div class="vertical-menu sidebar">
  <div data-simplebar class="h-100">
    ...
    <div class="user-profile text-center mt-3">
      <img src="{{ asset('Admin/assets/admin/images/users/PhotoAdmin.jpg') }}"
    ...
    <div id="sidebar-menu">
      <ul class="metismenu list-unstyled" id="side-menu">
        ...
        <li>
          <a href="{{ route('admin.formations.index') }}" class="waves-effect">
            <i class="ri-graduation-cap-line icon-formations"></i>
            <span>Formations</span>
          </a>
        </li>
        <li>
          <a href="{{ route('admin.modules.index') }}" class="waves-effect">
