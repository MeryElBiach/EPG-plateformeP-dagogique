    ...
    <div class="navbar-header">
        <div class="d-flex align-items-center">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('admin.dashboard') }}" class="logo logo-light d-flex align-items-center">
                    <img src="{{ asset('home/assets/images/epg.png') }}" alt="logo" height="32">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown user-dropdown">
                <button type="button" class="btn header-item waves-effect d-flex align-items-center"
                    ...
                    <img class="rounded-circle header-profile-user" src="{{ asset('Admin/assets/admin/images/users/PhotoAdmin.jpg') }}" alt="Avatar">
