...
<html lang="en">
    ...
    <!-- <body data-layout="horizontal" data-topbar="dark"> -->
        ...
        <div id="layout-wrapper">
            ...
            <!-- ========== Left Sidebar Start ========== -->
            <?php echo $__env->make('Admin.partials.Leftsidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <!-- Left Sidebar End -->
        ...
        <!-- Right Sidebar -->
         <?php echo $__env->make('Admin.partials.Rightsidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        <!-- /Right-bar -->
...
</html><?php /**PATH C:\xampp\htdocs\PROJECTS\GestionCour\resources\views/Admin/layout.blade.php ENDPATH**/ ?>