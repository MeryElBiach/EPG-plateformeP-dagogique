<footer>
  <section class="contact" id="contact" style="position: relative; color: white; min-height: 400px;">
    <div style="
      ...
      background:url('<?php echo e(asset('home/assets/images/back.jpg')); ?>')  center/cover no-repeat;
      filter: blur(3px);
      opacity: 0.85;
      z-index: -1;">
    </div>
...
</footer><?php /**PATH C:\xampp\htdocs\PROJECTS\GestionCour\resources\views/home/partials/footer.blade.php ENDPATH**/ ?>