        ...
        <div class="card h-100">
          <div class="card-body d-flex align-items-center">
            <div class="flex-grow-1">
              ...
              <h3 class="mb-1"><?php echo e($activeToday ?? 42); ?></h3>
              <small class="text-success">+ <?php echo e($pctActive ?? 12); ?>% vs hier</small>
              <div id="sparkline-students" class="apex-charts mt-2" data-series="[5,8,6,9,12,10,<?php echo e($activeToday ?? 42); ?>]"></div>
            </div>
        ...
        <div class="card h-100">
          <div class="card-body d-flex align-items-center">
            <div class="flex-grow-1">
              ...
              <h3 class="mb-1"><?php echo e($supportsThisMonth ?? 128); ?></h3>
              <small class="text-danger">– <?php echo e($pctSupports ?? 8); ?>% vs mois dernier</small>
              <div id="sparkline-supports" class="apex-charts mt-2" data-series="[10,15,12,20,25,22,<?php echo e($supportsThisMonth ?? 128); ?>]"></div>
            </div>
            <div class="avatar-sm ms-3">
        ...
        <div class="card h-100">
          <div class="card-body d-flex align-items-center">
            <div class="flex-grow-1">
              ...
              <h3 class="mb-1"><?php echo e($avgRating ?? 4.3); ?>/5</h3>
              <small class="text-success">+ <?php echo e($pctRating ?? 4); ?>% vs sem. passée</small>
              <div id="sparkline-rating" class="apex-charts mt-2" data-series="[3.5,3.8,4.0,4.2,4.1,4.3,<?php echo e($avgRating ?? 4.3); ?>]"></div>
            </div>
            <div class="avatar-sm ms-3">
        ...
        <div class="card h-100">
          <div class="card-body d-flex align-items-center">
            <div class="flex-grow-1">
              ...
              <h3 class="mb-1"><?php echo e($globalCompletion ?? 76); ?>%</h3>
              <small class="text-success">+ <?php echo e($pctCompletion ?? 5); ?>% vs dernier mois</small>
              <div class="progress mt-2" style="height:6px;">
                <div class="progress-bar bg-success" style="width: <?php echo e($globalCompletion ?? 76); ?>%;"></div>
              </div>
            </div>
            <div class="avatar-sm ms-3">
...
<?php echo $__env->make('Admin.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJECTS\GestionCour\resources\views/Admin/dash.blade.php ENDPATH**/ ?>