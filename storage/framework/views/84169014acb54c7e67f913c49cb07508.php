...
<div class="container py-4">
  ...
  <?php if($favoris->isEmpty()): ?>
    <div class="alert alert-info">Vous n'avez aucun support en favoris.</div>
  <?php else: ?>
    <div class="row">
      <?php $__currentLoopData = $favoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $support): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          ...
          <div class="support-card w-100 d-flex flex-column">
            ...
            <div id="eval-<?php echo e($support->id); ?>"
              ...
              <form method="POST"
                ...
                <?php echo csrf_field(); ?>
                <div class="etoiles mb-2" data-support="<?php echo e($support->id); ?>">
                  <?php for($i=1; $i<=5; $i++): ?>
...
<?php echo $__env->make('Etudiant.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJECTS\GestionCour\resources\views/Etudiant/Favoris/index.blade.php ENDPATH**/ ?>